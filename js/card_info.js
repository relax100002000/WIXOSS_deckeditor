...
var cardData = [
	...
	[
		...
		"「隊伍起」(回合1)綠0：我方3隻分別持有不同種族的精靈作對象，直到回合結束時為止，將他們的力量+3000。<br><br>「出」：【能量填充2】。此方法放置到能量區的卡牌不持有相同種族的話，追加【能量填充1】。"	//TW_TEXT
		],
	[
		"WXDi-D01-005", //ID
	...
	[
		...
		"「隊伍起」(回合1)白0：我方的1隻＜VTuber＞精靈作對象，直到下一個對方回合結束時為止，將其力量+2000。<br><br>「出」：查看我方牌組頂3張卡牌。將其中任意張＜VTuber＞精靈公開並加入手牌，剩下的按任意順序放回牌組下方。"	//TW_TEXT
		],
	[
		"WXDi-D02-05LAT", //ID
	...
	[
		...
		"「隊伍起」(回合1)白0：我方1隻＜VTuber＞精靈作對象，直到回合結束時為止，將其力量+4000。<br><br>「出」：對方1隻精靈作對象，將其返回手牌。抽1張牌。"	//TW_TEXT
		],
	[
		"WXDi-D02-14T", //ID
	...
	[
		...
		"「隊伍起」(回合1)1隻＜VTuber＞精靈從場上放置到廢棄區：對方1隻精靈作對象，直到回合結束時為止，將其力量-3000。<br><br>「出」：我方廢棄區最多2張＜VTuber＞精靈作對象，將其加入手牌。"	//TW_TEXT
		],
	[
		"WXDi-D02-17AT", //ID
	...
	[
		...
		"「隊伍起」(回合1)捨棄2張紅色卡的手牌：抽2張牌。<br><br>「出」：查看我方牌組頂3張卡牌。將其中任意張紅色卡牌公開並加入手牌，剩下的按任意順序放回牌組下方。"	//TW_TEXT
		],
	[
		"WXDi-P00-010", //ID
	...
	[
		...
		"「隊伍起」(回合1)藍0：我方1隻精靈作對象，將其配置到其他精靈區。<br><br>「出」：直到回合結束時為止，消去對方1個精靈區。(該處所有卡牌放置到廢棄區。玩家不能於該處配置精靈)"	//TW_TEXT
		],
	[
		"WXDi-P00-016", //ID
	...
	[
		...
		"「隊伍自」：此精靈攻擊時，此精靈的力量是20000以上的話，對方1隻精靈作對象，可以捨棄1張手牌。若如此做，將其返回手牌。<br><br>「起」(回合1)白1：公開我方手牌中任意張＜VTuber＞精靈。直到回合結束時為止，通過此方法公開的卡牌每有1張，此精靈的力量+1000。"	//TW_TEXT
		],
	[
		"WXDi-P00-034", //ID
	...
	[
		...
		"「隊伍自」：此精靈攻擊時，我方場上所有精靈是紅色的話，對方1隻力量12000以下的精靈作對象，可以支付紅2。若如此做，將其破壞。<br><br>「出」紅3：直到回合結束時為止，此精靈獲得【雙重擊潰】。(攻擊造成傷害時會擊潰2張生命護甲)"	//TW_TEXT
		],
	[
		"WXDi-P00-037", //ID
		...
		"「隊伍自」(回合1)：場上的此精靈移動到其他精靈區時，可以支付藍2。若如此做，不查看對方手牌最多選擇3張，再查看將1張放置到牌組下方。<br><br>「起」(回合1)藍2：對方牌組下方1張卡牌放置到廢棄區。之後，對方1隻卡名與該卡名相同的精靈作對象，將其破壞。"	//TW_TEXT
		],
	[
		"WXDi-P00-038", //ID
	...
	[
		...
		"「隊伍自」：我方攻擊階段開始時，此精靈力量是15000以上的話，對方1隻力量10000以上的精靈作對象，可以支付綠2。若如此做，將其破壞。<br><br>「自」：此精靈攻擊時，我方廢棄區精靈持有的種族合計7種以上的話，【能量填充1】。"	//TW_TEXT
		],
	[
		"WXDi-P00-041", //ID
		...
		"「隊伍常」：我方的生命護甲不會因重構移動到廢棄區。<br><br>「起」(回合1)黑1無1：對方1隻精靈作對象，直到回合結束時為止，將其力量-10000。我方牌組頂10張牌放置到廢棄區。"	//TW_TEXT
		],
	[
		"WXDi-P00-042", //ID
	...
	[
		...
		"「隊伍出」：查看我方牌組頂4張卡牌。將其中最多2張卡牌加入手牌，剩下的放置到廢棄區。<br><br>「起」(遊戲1)白0：直到回合結束時為止，此分身獲得「自：此分身攻擊的話，該攻擊結束時，該攻擊沒有給予對方傷害的話，可以橫置我方1隻等級2且豎直狀態的分身。若如此做，豎直此分身。」。"	//TW_TEXT
		],
	[
		"WXDi-D04-005", //ID
	...
	[
		...
		"「隊伍出」：抽1張卡牌。對方捨棄1張手牌。<br><br>「自」：此分身攻擊時，此分身下方的卡牌有5張以上的話，抽1張牌。7張以上的話，追加對方捨棄1張手牌。<br><br>「起」(遊戲1)藍0：我方其他分身下方的所有卡牌放置到此分身下方。"	//TW_TEXT
		],
	[
		"WXDi-D05-005", //ID
	...
	[
		...
		"「隊伍常」：我方回合中，對方中央精靈區的精靈力量-2000。<br><br>「出」：我方廢棄區1張精靈作對象，將其加入手牌。<br><br>「起」(遊戲1)黑0：我方1隻＜DIAGRAM＞等級1的分身作對象，將其返回分身牌組。（下方的卡牌留在場上）"	//TW_TEXT
		],
	[
		"WXDi-D06-005", //ID
